...
public class Editor extends javax.swing.JFrame {
	...
	JMenu QUICKMATHS = new JMenu("Quick Maths");
	...
	String userDictionaryPath = "/dictionaries/";
	// SET DICTIONARY PROVIDER FROM DICTIONARY PATH

	// SpellChecker.setUserDictionaryProvider(new
	// FileUserDictionary(userDictionaryPath));
	// REGISTER DICTIONARY
	// SpellChecker.registerDictionaries(getClass().getResource(userDictionaryPath),
	// "en");

	Thread spellCheckThread = new Thread(new Runnable() {
		@Override
		public void run() {
	...
	public Editor() {
		...
		MATHS.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// JOptionPane.showMessageDialog(aboutPanel, "<html><center>" + imagesrc +
				// "<br>" + message);
				...
				median = (double) (nums[(n - 1) / 2] + nums[n / 2]) / 2.0;
				...
				String modes = String.valueOf(mode);
				String medians = String.valueOf(median);
				String products = String.valueOf(product);

				JOptionPane.showMessageDialog(null,
						"Mean: " + means + "\nMode: " + modes + "\nMedian: " + medians + "\nSum: " + sums
								+ "\nProduct: " + products,
						"QUICK MATHS", JOptionPane.INFORMATION_MESSAGE);
		...
		ABOUT.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String message = "Created a txet editor\n" +
						"Author  Group of three\n" +
						"Version 07/04/2022\n" +
						"Can be used by anyone\n" +
						"Group Malhar,Koustubh and divyanshu\n" +
						"Can be made more volatile\n" +
						"--------------------";
